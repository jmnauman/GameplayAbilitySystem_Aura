...
DECLARE_MULTICAST_DELEGATE_TwoParams(FActivatePassiveAbilitySignature, const FGameplayTag& /*AbilityTag*/, bool /*bActivate*/)
...
public:
	...
	FActivatePassiveAbilitySignature ActivatedPassiveAbility;
